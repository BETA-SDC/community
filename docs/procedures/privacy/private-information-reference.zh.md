...
不要把私有内容复制到公开仓库。公开正文必须本身完整可读，并把普通引用链接直接放在它所支持的句子、条目或步骤后面。
...
```markdown
详细流程记录在[流程说明](https://github.com/BETA-SDC/community-private-information/blob/main/text/example.md)中。
```
...
应把附件引用直接放在它所支持的句子、条目或步骤后面，同时保证公开正文不依赖附件才能理解。

## 公开文档要求

- 公开文档应直接说明公开事实。
- 引用链接应在实际使用的位置支持公开说明，不应替代公开说明。
- 不要把敏感个人信息写入链接文字。
